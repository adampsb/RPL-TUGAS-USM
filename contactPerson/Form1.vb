...
Public Class Form1
    ...
    Dim Connection As New MySqlConnection("server=localhost; user=root; password=; database=toko")
    Dim MySQLCMD As New MySqlCommand
    Dim MySQLDA As New MySqlDataAdapter
    Dim DT As New DataTable

    Dim Table_Name As String = "product" 'your table name
    Dim Data As Integer
    ...
    Private Sub ClearInputUpdateData()
        ...
        TextBoxPrice.Text = ""
        TextBoxAmount.Text = ""
        PictureBoxImageInput.Image = My.Resources.pencil
    End Sub
